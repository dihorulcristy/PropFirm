...
const usaFirms = [
    ...
    },
    {
        ...
        pros: ['Lowest prices in industry', '90% profit split', 'Weekly payouts', '$69 for 50K account'],
        whyUSA: 'Incredible value for US futures traders. $69 gets you a 50K account.',
    },
    {
        rank: 3,
        name: 'InstantFunding',
