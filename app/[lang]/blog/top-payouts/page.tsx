...
const translations = {
    en: {
        ...
        intro: "Getting paid quickly is crucial for funded traders. Some prop firms process payouts in 24 hours, while others take 60+ days. We've analyzed thousands of trader reports to rank the 30 fastest-paying prop firms in 2025.",
        methodology: "Methodology",
        methodologyText: "Rankings based on average first payout processing time from hundreds of verified trader reports (November 2024 - November 2025). Times may vary based on payout method and account verification status.",
    ...
    ro: {
        ...
        title: "Top 30 Cele Mai Rapide Plăți Prop Firm în 2025",
        date: "25 Noiembrie, 2025",
        author: "Echipa PropFirmHub",
        readTime: "20 min citire",
        intro: "A fi plătit rapid este crucial pentru traderii finanțați. Unele firme prop procesează plățile în 24 ore, în timp ce altele durează 60+ zile. Am analizat mii de rapoarte de la traderi pentru a clasifica cele 30 de firme prop care plătesc cel mai rapid în 2025.",
        methodology: "Metodologie",
        methodologyText: "Clasamentele bazate pe timpul mediu de procesare a primei plăți din sute de rapoarte verificate ale traderilor (Noiembrie 2024 - Noiembrie 2025). Timpii pot varia în funcție de metoda de plată și statusul verificării contului.",
    ...
    es: {
        ...
        intro: "Cobrar rápido es crucial para los traders financiados. Algunas firmas prop procesan pagos en 24 horas, mientras que otras toman 60+ días. Hemos analizado miles de reportes de traders para clasificar las 30 firmas prop que pagan más rápido en 2025.",
        methodology: "Metodología",
        methodologyText: "Clasificaciones basadas en el tiempo promedio de procesamiento del primer pago de cientos de reportes verificados de traders (Noviembre 2024 - Noviembre 2025). Los tiempos pueden variar según el método de pago y el estado de verificación de la cuenta.",
