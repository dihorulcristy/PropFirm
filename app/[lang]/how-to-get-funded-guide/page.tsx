...
export default function HowToGetFundedGuide({ params }: PageProps) {
    ...
    const topPicks: { [key: string]: any[] } = {
        ...
        instant: [
            ...
            { name: 'FunderPro', logo: 'https://logo.clearbit.com/funderpro.com', rating: 4.8, price: '$549', advantage: lang === 'ro' ? 'Acces Rapid' : 'Quick Access', link: 'https://funderpro.cxclick.com/visit/?bta=35241&nci=5350', coupon: 'hgc', offer: '20% OFF' }
        ]
    };
