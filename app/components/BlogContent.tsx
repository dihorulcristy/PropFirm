...
const translations = {
    ...
    it: {
        title: "Blog PropFirmHub",
        subtitle: "Approfondimenti di esperti, guide dettagliate e le ultime tendenze nel prop trading. Tutto ciò di cui hai bisogno per avere successo come trader finanziato.",
        featured: "In Evidenza",
        readArticle: "Leggi Articolo",
        latestArticles: "Ultimi Articoli",
        readMore: "Leggi di Più",
        ctaTitle: "Pronto a Trovare la Tua Prop Firm Perfetta?",
        ctaSubtitle: "Confronta le migliori prop firm fianco a fianco e trova quella più adatta al tuo stile di trading.",
        ctaButton: "Confronta Prop Firm →"
    }
};
...
const blogPosts = {
    ...
    ro: [
        ...
        {
            slug: 'top-payouts',
            title: 'Top 30 Cele Mai Rapide Plăți Prop Firm 2026',
    ...
    it: [
        {
            ...
            description: 'Scopri perché 8 trader su 10 falliscono la sfida FTMO e impara le strategie esatte per superarla. Regole di perdita giornaliera, risk management e consigli comprovati.',
            date: '10 Gennaio, 2026',
            readTime: '12 min lettura',
            category: 'Guida',
            featured: true,
        },
        {
            slug: 'how-to-pass-prop-firm-challenge',
            title: 'Come Superare una Sfida Prop Firm: 10 Passaggi Comprovati',
            description: 'Impara esattamente come superare le sfide prop firm con la nostra guida completa. Scopri strategie di risk management, obiettivi di profitto e consigli di psicologia.',
            date: '30 Dicembre, 2026',
            readTime: '15 min lettura',
            category: 'Guida',
            featured: false,
        },
        {
            slug: 'pass-rates-2026',
            title: 'Tassi di Superamento Sfida Prop Firm 2026: Statistiche Reali',
            description: 'Scopri i tassi reali di superamento delle sfide prop firm nel 2026. Abbiamo analizzato oltre 15 firm per rivelare i tassi di successo effettivi.',
            date: '7 Gennaio, 2026',
            readTime: '12 min lettura',
        ...
        {
            slug: 'how-hard-is-it-to-get-funded-trading',
            title: 'Quanto è Difficile Ottenere un Finanziamento nel Trading?',
            description: 'Scopri la reale difficoltà di ottenere un finanziamento nel prop trading. Impara tassi di successo, sfide principali e strategie comprovate per aumentare le tue possibilità.',
        ...
        {
            slug: 'what-is-prop-firm-account',
            title: 'Cos\'è un Conto Prop Firm?',
            description: 'Impara tutto sui conti prop firm: come funzionano, vantaggi, rischi e come ottenerne uno. Guida completa ai conti di trading proprietario per trader forex e futures.',
        ...
        {
            slug: 'top-payouts',
            title: 'I 30 Pagamenti Più Veloci delle Prop Firm nel 2026',
            description: 'Essere pagati rapidamente è fondamentale. Alcune firm pagano in 24 ore, altre impiegano oltre 60 giorni. Abbiamo analizzato migliaia di pagamenti per classificare le 30 firm più veloci.',
            date: '25 Novembre, 2026',
            readTime: '20 min lettura',
            category: 'Classifiche',
            featured: false,
        },
        {
            slug: 'taxes-2025',
            title: 'Tasse Prop Firm 2026: Guida Completa per Trader',
            description: 'Le tasse sui profitti delle prop firm possono essere confuse. Sei un dipendente? Un collaboratore indipendente? Questa guida completa risponde a tutte le tue domande sulla tassazione delle prop firm.',
            date: '25 Novembre, 2026',
            readTime: '18 min lettura',
            category: 'Finanza',
            featured: false,
        },
    ]
