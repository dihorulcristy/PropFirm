        ...
        <section className="py-4 sm:py-6">
            <div className="container mx-auto px-3 sm:px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 max-w-7xl mx-auto">
                    ...
                    <motion.div
                        className="group relative overflow-hidden rounded-xl sm:rounded-2xl border border-emerald-500/20 bg-gradient-to-br from-emerald-950/90 via-slate-900/90 to-red-950/90 backdrop-blur-sm shadow-lg hover:shadow-emerald-500/20 transition-all duration-300"
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                    ...
                    >
                        {/* Animated gradient overlay */}
                        <div className="absolute inset-0 bg-gradient-to-br from-emerald-600/10 via-transparent to-red-600/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                        {/* Shimmer Effect */}
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-emerald-400/5 to-transparent animate-shimmer animation-delay-1000"></div>
                        ...
                        <div className="relative p-3 sm:p-4 md:p-5">
                            ...
                            <div className="mb-3 sm:mb-4">
                                <div className="flex items-center gap-2 sm:gap-3 mb-1.5 sm:mb-2">
                                    ...
                                    />
                                    <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white italic leading-none drop-shadow-lg">
                                        YRM <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600">PROP</span>
                                    </h3>
                                </div>
                                <div className="space-y-1">
                                    <p className="text-white text-lg sm:text-xl font-black leading-tight">
                                        $50K FOR <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600">$45</span>
                                    </p>
                                    <p className="text-slate-300 text-[10px] sm:text-xs font-medium">
                                        $100K FOR $95 • $150K FOR $145
                                    </p>
                                    <p className="text-slate-200 text-xs sm:text-sm leading-relaxed mt-2">
                                        {t.useCode} <span className="inline-flex items-center font-mono text-white bg-gradient-to-r from-emerald-600 to-emerald-700 px-2 py-0.5 rounded-md text-[10px] sm:text-xs font-bold shadow-md">HGC</span> for EXTRA 10% OFF
                                    </p>
                                </div>
                            </div>
