...
export const pageTranslations = {
    ...
    it: {
        ...
        challengeRules: 'Regole della Sfida',
        tradingPlatforms: 'Piattaforme di Trading',
        ...
        payoutSpeed: 'Velocità di Pagamento',
        days: 'giorni',
        accountSize: 'Dimensione Conto',
        price: 'Prezzo',
        discount: 'Sconto',
        backToCompare: 'Torna al Confronto',
        verified: 'Firma Verificata',
        rating: 'Valutazione',
        ...
        newsTrading: 'Trading sulle Notizie',
        yes: 'Sì',
        no: 'No',
        faqTitle: 'Domande Frequenti',
        faq1Q: 'Questa prop firm è legittima?',
        faq1A: 'Sì, questa è una firma di prop trading verificata con un track record di pagamenti ai trader.',
        faq2Q: 'Quanto tempo ci vuole per essere finanziati?',
        faq2A: 'Dopo aver superato le fasi di valutazione, in genere vieni finanziato entro 24-48 ore.',
        faq3Q: 'Posso usare il codice sconto?',
        faq3A: 'Sì, il codice sconto mostrato è attualmente attivo e verrà applicato al checkout.',
        ctaTitle: 'Pronto per Iniziare a Fare Trading?',
        ctaText: 'Unisciti a migliaia di trader finanziati. Inizia la tua sfida oggi.',
        relatedFirms: 'Prop Firm Simili'
    }
};
